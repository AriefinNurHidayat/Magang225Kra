                    ...
                    <div class="card rounded-4" style="box-shadow: 5px 5px 20px 1px rgba(0,0,0, 0.20)">
                        ...
                        <form action="{{ route('ruang.store') }}" method="POST" class="p-4 row">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" name="tanggal" class="form-control border border-2 shadow-sm px-2" placeholder="{{ $data->tanggal }}"
                                    required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="kegiatan"
                                    class="form-control border border-2 shadow-sm px-2" placeholder="{{ $data->kegiatan }}" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-bold">Leading Sector</label>
                                <input type="text" name="sector" class="form-control border border-2 shadow-sm px-2" placeholder="{{ $data->sector }}"
                                    required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-bold">Petugas</label>
                                <input type="text" name="petugas" class="form-control border border-2 shadow-sm px-2" placeholder="{{ $data->petugas }}"
                                    required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-bold">Tempat</label>
                                <input type="text" name="tempat" class="form-control border border-2 shadow-sm px-2" placeholder="{{ $data->tempat }}"
                                    required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-bold">Keterangan</label>
                                <textarea name="Keterangan" class="form-control border border-2 shadow-sm px-2" placeholder="{{ $data->keterangan }}"></textarea>
                            </div>
